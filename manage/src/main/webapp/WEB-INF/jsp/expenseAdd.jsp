...
<div class="formbody">
    ...
    <form action="exp/expAdd" method="post" enctype="multipart/form-data">
        <ul class="forminfo">
            <li>
                <label>报销人</label>
                ...
                <%
                    ...
                    Employee employee = (Employee)session1.getAttribute("emp");
                %>
                <input name="empid" type="text" class="dfinput"  value="<%= employee.getEmpid()%>"/><i></i></li>
            <li>

                <label>报销时间</label>
                <input name="exptime" type="text" class="dfinput"  value="<%= date%>"/><i></i></li>
            <li>
            <li>
                <label>具体报销项</label>
